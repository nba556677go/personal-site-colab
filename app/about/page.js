            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex flex-row space-x-3 pt-6">
                <IconContext.Provider value={{ className: "social-icon" }}> 
                  ...
                  <div>
                    <a href="/static/cv/resume_202608.pdf" rel="noopener noreferrer" target="_blank"> <TbFileCv /> </a>
                  </div>
                  <div>
                    <a
                      href="https://scholar.google.com/citations?user=kMy9hCUAAAAJ"
                      rel="noopener noreferrer"
                      target="_blank"> <SiGooglescholar /> 
                    </a>
                  </div>
